...
namespace SharpNodeSettings.Node.Regular {
    ...
    public class RegularNodeTypeItem {
        ...
        ///     double数据类型
        /// </summary>
        public static readonly RegularNodeTypeItem Double =
            new RegularNodeTypeItem(10, "double", Brushes.LightGoldenrodYellow, 8);

        /// <summary>
        ///     string数据类型，ASCII编码
        /// </summary>
        public static readonly RegularNodeTypeItem
            StringAscii = new RegularNodeTypeItem(11, "ascii", Brushes.Yellow, 0);

        /// <summary>
        ///     string数据类型，Unicode编码
        /// </summary>
        public static readonly RegularNodeTypeItem StringUnicode =
            new RegularNodeTypeItem(12, "unicode", Brushes.YellowGreen, 0);

        /// <summary>
        ///     string数据类型，UTF8编码
        /// </summary>
        public static readonly RegularNodeTypeItem StringUtf8 =
            new RegularNodeTypeItem(13, "utf8", Brushes.SandyBrown, 0);
