...
namespace SharpNodeSettings.Device {
    ...
    public class DeviceSiemens : DeviceCore {
        ...
        public DeviceSiemens(XElement element) {
            var nodeSiemens = new NodeSiemens();
        ...
        private readonly SiemensS7Net siemensS7Net; // S7协议交互对象
        private readonly SiemensFetchWriteNet siemensFetchWrite; // FW协议交互对象
        private readonly bool isS7Net = true; // 是否是S7协议
